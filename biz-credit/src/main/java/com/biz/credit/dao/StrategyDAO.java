...
public interface StrategyDAO {
    ...
    List<ParamVO> queryFlowParams(@Param("apiCode") String apiCode, @Param("flowId") Integer flowId);

    ProductVO queryProductByFlowId(@Param("apiCode") String apiCode, @Param("flowId") Integer flowId);

    EntityBasic queryBasicInfo(@Param("companyName") String companyName);
}
