...
public class DateUtil {
    ...
    public static final String PERIOD_7_DAY = "7D";    //最近周期：7天
    public static final String PERIOD_1_MONTH = "1M";    //最近周期：1月
    public static final String PERIOD_2_MONTH = "2M";    //最近周期：2月
    public static final String PERIOD_3_MONTH = "3M";    //最近周期：3月
    public static final String PERIOD_4_MONTH = "4M";    //最近周期：4月
    public static final String PERIOD_5_MONTH = "5M";    //最近周期：5月
    public static final String PERIOD_6_MONTH = "6M";    //最近周期：6月
    public static final String PERIOD_1_YEAR = "1Y";    //最近周期：1年
     ...
     * @return 计算后的日期
     */
    public static Date addDate(Date date,String period){
        Calendar c = Calendar.getInstance();
        c.setTime(date);
        if(period.equals(PERIOD_7_DAY)){
            c.add(Calendar.DATE, -7);//加减天数
            return c.getTime();
        }
        else if(period.equals(PERIOD_1_MONTH)){
            c.add(Calendar.MONTH, -1);//加减天数
            return c.getTime();
        }
        else if(period.equals(PERIOD_2_MONTH)){
            c.add(Calendar.MONTH, -2);//加减天数
            return c.getTime();
        }
        else if(period.equals(PERIOD_3_MONTH)){
            c.add(Calendar.MONTH, -3);//加减天数
            return c.getTime();
        }
        else if(period.equals(PERIOD_4_MONTH)){
            c.add(Calendar.MONTH, -4);//加减天数
            return c.getTime();
        }
        else if(period.equals(PERIOD_5_MONTH)){
            c.add(Calendar.MONTH, -5);//加减天数
            return c.getTime();
        }
        else if(period.equals(PERIOD_6_MONTH)){
            c.add(Calendar.MONTH, -6);//加减天数
            return c.getTime();
        }
        else if(period.equals(PERIOD_1_MONTH)){
            c.add(Calendar.YEAR, -1);//加减天数
            return c.getTime();
        }
        return null;
    }
    ...
    public static void main(String [] args){
        System.out.println(parseDateToStr(addDate(new Date(),"3M"),DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS));
